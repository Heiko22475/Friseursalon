// =====================================================
// CARD TEAM EDITOR PAGE
// Wrapper-Seite für CardTeamEditor mit Navigation
// =====================================================
...
export const CardTeamEditorPage: React.FC = () => {
  ...
  const [config, setConfig] = useState<CardTeamConfig | null>(null);
  ...
  useEffect(() => {
    if (block) {
      setConfig(block.config && Object.keys(block.config).length > 0 
        ? block.config as CardTeamConfig 
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          {/* Editor */}
          <CardTeamEditor config={config} onChange={setConfig} />
        </div>
...
export default CardTeamEditorPage;
